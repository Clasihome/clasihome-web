...
const items = [
  {
    ...
    description:
      "<p>Carga propiedades de forma sencilla e intuitiva.</p><p>Inclue videos, tours virtuales, compartelas por correo y WhatsApp.</p>",
  },
  {
    id: uuid(),
    ...
    description:
      "<p>Gestiona profesionalmente tus órdenes de visita y compártelas fácilmente, realiza un seguimiento de ellas. Podrás adjuntar varias propiedades en una misma orden.</p>",
  },
  {
    id: uuid(),
    ...
    description:
      "<p>Agrega contactos y manténlos al tanto de las mejores propiedades. Recuerda que un contacto, es una oportunidad.</p>",
  },
]
      ...
      <Col xs={24} md={14}>
        {index === 0 && (
          <div className="property-images-section">
            <Sphere size={150} rotation={45} className="property-sphere" />
            <Bounce
              left={size.width <= 768 ? true : false}
              right={size.width >= 768 ? true : false}
            >
        ...
        {index === 2 && (
          <div className="contact-images-section">
            <Sphere size={244} rotation={0} className="contact-sphere" />
            <Bounce
              left={size.width <= 768 ? true : false}
              bottom={size.width >= 768 ? true : false}
            >
            ...
            <Sphere size={500} rotation={0} className="contact-sphere-2" />
          </div>
        )}
      </Col>
    </Row>
          ...
          >
            ...
            <Container>
              <div className="carousel-text-dots-container">
                {items.map((item, i) => (
                  <Dot className="carousel-text-dot" key={item.id} slide={i} />
                ))}
              </div>
            </Container>
          </CarouselProvider>
