      ...
      <div className="hero-main-cont">
        ...
        <section className="hero-cont">
          <div className="hero-image-background">
            <img src="/hero-customers/hero-1.jpg" />
            <h1>
              <span className="hero-info-animate">Ellos </span>
              <span className="hero-info-animate">eligieron </span>
              <span className="hero-info-animate">la excelencia</span>
            </h1>
            <p>
          ...
          <div id="avatar-left">
            <Avatar size={175} src="/hero-customers/customer-1.jpg">
              <h3>ClasiHome</h3>
              <small>Conectamos propiedades con clientes.</small>
            </Avatar>
          </div>
          <div id="avatar-right">
            <Avatar size={130} src="/hero-customers/customer-2.jpg">
              <h3>ClasiHome</h3>
              <small>Conectamos propiedades con clientes.</small>
            </Avatar>
          </div>
